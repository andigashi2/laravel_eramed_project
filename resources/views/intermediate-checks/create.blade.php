<table id="intermediate-check-table" class="table table-bordered" >
    ...
    <tbody>
        <tr>
            ...
            <td><input class="form-control" type="text" name="measurement[]" required /></td>
            <td><input class="form-control" type="text" name="expanded_uncertainty[]" required /></td>
            <td><input class="form-control" type="date" name="max_mpe[]" required /></td>
            <td>
