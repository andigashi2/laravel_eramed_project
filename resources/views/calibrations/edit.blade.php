<table id="calibrationTable" class="table table-bordered" >
    ...
    <tbody>
        @foreach($device->calibrations as $key => $calibration)
            <tr>
                <td><input class="form-control" type="date" name="cal_date[]" value="{{$calibration->cal_date}}"/></td>
                <td><input class="form-control" type="text" name="nr_cert_cal[]" value="{{$calibration->nr_cert_cal}}"/></td>
                <td><input class="form-control" type="text" name="cal_lab[]" value="{{$calibration->cal_lab}}"/></td>
                <td><input class="form-control" type="date" name="cal_due_date[]" value="{{$calibration->cal_due_date}}"/></td>
                <td>
